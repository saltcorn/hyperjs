...
export declare class Server {
  ...
  constructor()
  delete(route: string, handler: JsHandlerFn | JsHandlerFnErrorHandler): void
  get(route: string, handler: JsHandlerFn | JsHandlerFnErrorHandler): void
  post(route: string, handler: JsHandlerFn | JsHandlerFnErrorHandler): void
  put(route: string, handler: JsHandlerFn | JsHandlerFnErrorHandler): void
  use(route: string | undefined | null, middleware: JsHandlerFn | JsHandlerFnErrorHandler): void
...
export type JsHandlerFn =
  (arg0: Request, arg1: Response) => unknown

export type JsHandlerFnErrorHandler =
  (arg0: unknown, arg1: Request, arg2: Response) => unknown
...
export type JsSetHeadersFn =
  (arg0: Response, arg1: string, arg2: FileStat) => void
...
export type JsVerifyFn =
  (arg0: Request, arg1: Response, arg2: Buffer, arg3: string) => void
